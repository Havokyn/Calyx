...
## Combined contents
- `00_INDEX.md`- `01_system_overview.md`- `02_source_code_map.md`- `03_configuration.md`- `04_storage_and_schema.md`- `05_core.md`- `06_aster_storage_engine.md`- `07_forge_math_runtime.md`- `08_registry_lenses.md`- `09_sextant_search.md`- `10_loom_associations.md`- `11_assay_signal_bits.md`- `12_lodestar_kernel.md`- `13_ward_guard.md`- `14_ledger_provenance.md`- `15_anneal_optimization.md`- `16_oracle_prediction.md`- `17_graph_mincut_paths.md`- `18_hazard_soak_and_testkit.md`- `19_mcp_api_tools_reference.md`- `20_cli_and_daemon_reference.md`- `21_test_suite.md`- `22_verification_report.md`- `23_planning_docs_summary.md`- `24_roadmap.md`
